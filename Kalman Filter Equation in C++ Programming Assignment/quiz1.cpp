...
VectorXd x;	// object state - initial state (location and velocity)
MatrixXd P;	// object covariance matrix # initial uncertainty
VectorXd u;	// external motion # external motion
MatrixXd F; // state transition matrix # next state function
MatrixXd H;	// measurement matrix # measurement function
MatrixXd R;	// measurement covariance matrix # measurement uncertainty
MatrixXd I; // Identity matrix # identity matrix
